            ...
            while (voltaInicio == 0)
            {
                ...
                while (adminFlag == 0)
                {
                    ...
                    if (admin == "S" || admin == "s")
                    {
                        ...
                        int alteracaoPrecosLoop2 = 0;
                        int alteracaoPreçosLoop = 0;

                        while (alteracaoPreçosLoop == 0 && passwordFlag == 1)

                        {
                            ...
                            Console.WriteLine("");
                            Console.WriteLine("Pretende alterar os Produtos & Preços?");
                            Console.WriteLine("");
                            Console.WriteLine("[S] para Sim ou [N] para Não");
                            Console.WriteLine("");

                            alteracaopreco = Console.ReadLine();

                            alteracaoPrecosLoop2 = 0;
                            while (alteracaoPrecosLoop2 == 0)
                            {

                                if (alteracaopreco == "s" || alteracaopreco == "S") //Permite alterar todos os produtos de seguida ou escolher produto a editar
                                {

                                    Console.WriteLine("");
                                    Console.WriteLine("Como quer alterar Produtos?");
                                    Console.WriteLine("");
                                    ...
                                    while (alterarTodosLoop == 0)
                                    {
                                        ...
                                        {
                                            alterarTodosLoop = 1;
                                            alteracaoPreçosLoop = 1;
                                            alteracaoPrecosLoop2 = 1;
                                        }

                                        else
                                        {
                                            Console.WriteLine("Apenas [A] & [N] ou [X] são válidos");
                                            alterartodos = Console.ReadLine();
                                ...
                                else if (alteracaopreco == "n" || alteracaopreco == "N")
                                {
                                    alteracaoPreçosLoop = 1;
                                    alteracaoPrecosLoop2 = 1;
                                ...
                                {
                                    Console.WriteLine("");
                                    Console.WriteLine("Só [S] , [N] são válidos");
                                    alteracaopreco = Console.ReadLine();
                                }
                            }
                        }
                ...
                while (avancaCompra == 0)
                {
                    for (int i = 0; i < menu.GetLength(0); i++)
                    {
                        ...
                        Console.WriteLine("Produto: " + menu[i, 1] + " - Código " + (menu[i, 0]));
                    ...
                    do
                    {
                        ...
                        if (int.TryParse(validInt, out menuConsulta))
                        {
                            menuConsulta = int.Parse(validInt, CultureInfo.InvariantCulture);
                            validNumeric = 0;
                            validInt = "";
                        }
                        else
                        {
                            Console.WriteLine("");
                            Console.WriteLine("Caractere inválido. Apenas números são permitidos");
                            Console.WriteLine("");
                            validNumeric = 1;
                        }
                    } while (validNumeric == 1);
                ...
                while (valorInsuf == 0)
                {
                    ...
                    while (multiCompra == 0)
                    {
                        ...
                        while (validNumeric == 0)
                        {
                            ...
                            if (int.TryParse(validInt, out menuCompra))
                            {
                                menuCompra = int.Parse(validInt, CultureInfo.InvariantCulture);
                                validNumeric = 1;
                            }
                            else
                            {
                        ...
                        switch (menuCompra)
                        {
                            ...
                            case 1:
                                ...
                                if (valorTotal < Convert.ToDouble(menu[0, 2], CultureInfo.CurrentCulture))
                                {
                                    ...
                                    valorParcial = double.Parse(Console.ReadLine(), CultureInfo.CurrentCulture);
                                    multiCompra = 1;
                                    valorInsuf = 0;
                                }
                                else
                                {
                                    ...
                                    valorTotal = valorTotal - (Convert.ToDouble(menu[0, 2], CultureInfo.CurrentCulture));
                                    valorTotal = Math.Round(valorTotal, 2);
                            ...
                            case 2:
                                ...
                                Console.WriteLine("Preço " + menu[1, 2] + " euros");
                                if (valorTotal < Convert.ToDouble(menu[1, 2], CultureInfo.CurrentCulture))
                                {
                                    Console.WriteLine("O seu salde é de " + valorTotal + " euros que é insuficiente para esta compra");
                                    Console.WriteLine("Introduza mais valor");
                                ...
                                {
                                    valorTotal = valorTotal - Convert.ToDouble(menu[1, 2], CultureInfo.CurrentCulture);
                                    valorTotal = Math.Round(valorTotal, 2);
                                    Console.WriteLine("O seu saldo é de " + valorTotal);
                            ...
                            case 3:
                                ...
                                Console.WriteLine("Preço " + menu[2, 2] + " euros");
                                if (valorTotal < Convert.ToDouble(menu[2, 2], CultureInfo.CurrentCulture))
                                {
                                    Console.WriteLine("O seu salde é de " + valorTotal + " euros que é insuficiente para esta compra");
                                    Console.WriteLine("Introduza mais valor");
                                    valorParcial = double.Parse(Console.ReadLine(), CultureInfo.InvariantCulture);
                                ...
                                {
                                    valorTotal = valorTotal - Convert.ToDouble(menu[2, 2], CultureInfo.CurrentCulture);
                                    valorTotal = Math.Round(valorTotal, 2);
                                    Console.WriteLine("O seu saldo é de " + valorTotal);
                            ...
                            case 4:
                                ...
                                Console.WriteLine("Preço " + menu[3, 2] + " euros");
                                if (valorTotal < Convert.ToDouble(menu[3, 2], CultureInfo.CurrentCulture))
                                {
                                    Console.WriteLine("O seu salde é de " + valorTotal + " euros que é insuficiente para esta compra");
                                    Console.WriteLine("Introduza mais valor");
                                    valorParcial = double.Parse(Console.ReadLine(), CultureInfo.InvariantCulture);
                                ...
                                {
                                    valorTotal = valorTotal - Convert.ToDouble(menu[3, 2], CultureInfo.CurrentCulture);
                                    valorTotal = Math.Round(valorTotal, 2);
                                    Console.WriteLine("O seu saldo é de " + valorTotal);
                            ...
                            case 5:
                                ...
                                Console.WriteLine("Preço " + menu[4, 2] + " euros");
                                if (valorTotal < Convert.ToDouble(menu[4, 2], CultureInfo.CurrentCulture))
                                {
                                    Console.WriteLine("O seu salde é de " + valorTotal + " euros que é insuficiente para esta compra");
                                    Console.WriteLine("Introduza mais valor");
                                    valorParcial = double.Parse(Console.ReadLine(), CultureInfo.InvariantCulture);
                                ...
                                {
                                    valorTotal = valorTotal - Convert.ToDouble(menu[4, 2], CultureInfo.CurrentCulture);
                                    valorTotal = Math.Round(valorTotal, 2);
                                    Console.WriteLine("O seu saldo é de " + valorTotal);
                            ...
                            case 6:
                                ...
                                Console.WriteLine("Preço " + menu[5, 2] + " euros");
                                if (valorTotal < Convert.ToDouble(menu[5, 2], CultureInfo.CurrentCulture))
                                {
                                    Console.WriteLine("O seu salde é de " + valorTotal + " euros que é insuficiente para esta compra");
                                    Console.WriteLine("Introduza mais valor");
                                    valorParcial = double.Parse(Console.ReadLine(), CultureInfo.InvariantCulture);
                                ...
                                {
                                    valorTotal = valorTotal - Convert.ToDouble(menu[5, 2], CultureInfo.CurrentCulture);
                                    valorTotal = Math.Round(valorTotal, 2);
                                    Console.WriteLine("O seu saldo é de " + valorTotal);
